function createPlannerCurrency (category, count) {
    return {
        'type': 'currency',
        'category': category,
        'count': count
...
function createPlannerElement (materialType, materialTier, count) {
    return {
        'type': 'element',
...
function createPlannerClass (materialType, count) {
    return {
        'type': 'class',
        'materialType': materialType,
        'count': count
...
function createPlannerBahamut (materialType, count) {
    return {
        'type': 'bahamut',
        'materialType': materialType,
        'count': count
...
function createPlannerRevenantFiveStar (materialType, count) {
    return {
...
function createPlannerSupply (category, id, count) {
    return {
        'type': 'supply',
        'category': category,
        'id': id,
...
function createSupplyInfo (category, id) {
    return {
        'category': category,
        'id': id
    }
...
function createClass (type, avenger, skofnung, nirvana, keraunos, oliver, hellion, ipetam, rosenbogen, langeleik, romulus, faust, murakumo, muramasa, ascalon, nebuchad, kapilavastu, misericorde) {
    return {
...
function createRevenantFiveStar (type, uno, song, sarasa, quatre, funf, six, siete, octo, nio, esser) {
    return {
